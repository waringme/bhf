...
async function loadEager(doc) {
  ...
  // Initialize LCP optimization after Target has had time to process
  setTimeout(() => {
    initLCPOptimization();
  }, 150);
  ...
  if (main) {
    decorateMain(main);
    // Small delay to ensure Target has processed before showing the page
    setTimeout(() => {
...
function loadDelayed() {
  ...
  window.setTimeout(() => import('./delayed.js'), 1000); // Reduced from 3000ms to 1000ms for faster Target initialization
